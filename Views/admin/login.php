            ...
            <div class="row align-items-center">
                <div class="col-lg-5 offset-lg-1 mx-auto">
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="p-2">
                                <h4 class="text-muted float-right font-18 mt-4">Iniciar Sesion</h4>
                                <div>
                            ...
                            <div class="p-2">
                                <form class="form-horizontal m-t-20" id="formulario" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <input class="form-control" id="clave" name="clave" type="password" required="" value="" placeholder="Contraseña">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-t-10 mb-0 row">
                                        <div class="col-sm-7 m-t-20">
                                            <a href="<?php echo BASE_URL . 'principal/recoverpw'; ?>" class="text-muted"><i class="mdi mdi-lock"></i> Olvido su contraseña?</a>
                                        </div>
                                    </div>
