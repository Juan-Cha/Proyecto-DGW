            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <?php if ($data['title'] == 'Pagina Principal') { ?>
                        <div class="hero__item set-bg" data-setbg="<?php echo BASE_URL; ?>public/img/hero/productos-tecnologicos.webp">
                            <div class="hero__text">
                                <span>PRODUCTOS INTELIGENTES</span>
                                <h2>Los Mejores Productos <br />Disponibles</h2>
