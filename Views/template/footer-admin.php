...
<footer class="footer">
Todo el diseño, el texto, los gráficos y la selección y disposición del Sitio web son propiedad de la Compañía ByteZone. © <?php echo date('Y'); ?> <span class="d-none d-md-inline-block"></span>
</footer>
