    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="footer__about">
          ...
          <ul>
            ...
            <li>Correo electronico: <?php echo $data['negocio']['correo']; ?></li>
          </ul>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
        <div class="footer__widget">
          ...
          <ul>
            ...
            <li><a href="<?php echo BASE_URL; ?>/principal/contactos/">Contáctenos</a></li>
          </ul>
        </div>
      </div>
      <div class="col-lg-4 col-md-12">
        <div class="footer__widget">
          ...
          <form action="<?php echo BASE_URL ?>/Controllers/correo.php" method = "post">
          ...
          <div class="footer__widget__social">
            ...
            <a href="https://mx.pinterest.com/"><i class="fa fa-pinterest-p"></i></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="footer__copyright">
          <div class="footer__copyright__text">
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              Copyright ByteZone &copy;<script>
