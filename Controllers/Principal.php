                                    ...
                                    <head>
                                        ...
                                        <style>
                                            .boton {
                                                ...
                                                padding: 15px 25px;
                                                background-color: #0046d5; /* Azul intenso */
                                            ...
                                            .boton:hover {
                                                background-color: #003bb3; /* Azul más oscuro al pasar el mouse */
                                                color: #ffffff; /* Asegurarse de que el texto siga siendo blanco */
                                            }
                                        </style>
                                    </head>
                                    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f9f9f9; color: #333;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background-color: #fff; border: 1px solid #e0e0e0; border-radius: 8px;">
                                            <tr>
                                                <td style="padding: 20px; text-align: center; background-color: #0046d5; color: #fff; border-top-left-radius: 8px; border-top-right-radius: 8px;">
                                            ...
                                            <tr>
                                                <td style="padding: 20px;">
                                                    ...
                                                    <p>Recibimos una solicitud para restablecer tu contraseña en <strong>'.TITLE.'</strong>. Si fuiste tú quien hizo esta solicitud, haz clic en el botón a continuación para crear una nueva contraseña:</p>
                                                    <div style="text-align: center; margin: 20px 0;">
                                                        <a href="' . BASE_URL . 'principal/reset/' . $token . '" class="boton">
                                                            Restablecer mi contraseña
                                                        </a>
                                                    </div>
                                                    <p>Si no realizaste esta solicitud, puedes ignorar este mensaje y tu cuenta seguirá protegida.</p>
                                                    <p>Por seguridad, este enlace será válido únicamente por las próximas <strong>24 horas</strong>.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 20px; background-color: #f0f0f0; text-align: center; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                                                    <p style="margin: 0; font-size: 14px;">Si tienes preguntas, contáctanos en <a href="mailto:'.$negocio['user_smtp'].'" style="color: #0046d5;">'.$negocio['user_smtp'].'</a>.</p>
                                                    <p style="margin: 10px 0 0; font-size: 12px; color: #777;">Este es un mensaje automático. Por favor, no respondas a este correo.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </body>
